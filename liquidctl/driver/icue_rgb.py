"""liquidctl drivers for Corsair iCUE RGB ELITE

Supported devices:

- Corsair iCUE H100i RGB ELITE

Copyright Jonas Malaco and contributors.. (st1vms)
...
class iCueRGB(UsbHidDriver):
    """Corsair iCUE RGB ELITE coolers"""

    _MATCHES = [
        (0x1b1c, 0x0c35, 'Corsair iCUE H100i RGB ELITE',
            {'fan_count': 2, 'fan_leds': 0, 'has_pump':True, 'led_channels':1}),
    ]
