...
liquidctl $DEVICE $EXTRAOPTIONS set led color rainbow
sleep 4

liquidctl $DEVICE $EXTRAOPTIONS set led color rainbow --speed 1
sleep 4

liquidctl $DEVICE $EXTRAOPTIONS set led color rainbow --speed 6
sleep 4
