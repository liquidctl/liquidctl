...
| :-: | :-- | :-: | :-- |
| AIO liquid cooler | [Corsair Hydro H100i Pro XT, H115i Pro XT](docs/corsair-platinum-pro-xt-guide.md) | USB HID | <sup>_EU_</sup> |
...
<!-- No executable is made available for 1.5.2; try to use the latest stable release instead -->
