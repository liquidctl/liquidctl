...
| Fan/LED controller | [Corsair Commander ST](docs/corsair-commander-core-guide.md) | <sup>_ep_</sup> | git |
...
| Fan/LED controller | [NZXT RGB & Fan Controller (3+6 channels)](docs/nzxt-hue2-guide.md) | <sup>_ehp_</sup> | git |
