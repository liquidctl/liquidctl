...
class CorsairHidPsu(UsbHidDriver):
    ...
    _MATCHES = [
        ...
        (0x1b1c, 0x1c07, 'Corsair HX1000i', {  # CP-9020074-NA
        ...
        (0x1b1c, 0x1c23, 'Corsair HX1200i ATX 3.0', {
            'fpowin115': (7.173099583444791e-05 1.0136201118184893 13.222597174452899),
            'fpowin230': (7.173099583444791e-05 1.0136201118184893 13.222597174452899),
        }),
        ...
        (0x1b1c, 0x1c1e, 'Corsair HX1000i (2022)', {  # CP-9020214-NA
            # FIXME does not accurately represent known efficiency curve at 2%–10% loads
            'fpowin115': (0.00012038623467957958, 0.9899868099948035, 13.125601514017152),
            'fpowin230': ( 8.725695209710315e-05, 1.0017598021499974,  9.789546063300154),
        }),
        (0x1b1c, 0x1c1f, 'Corsair HX1500i', {  # CP-9020215-NA
            # FIXME does not accurately represent known efficiency curve at 2%–10% loads
            'fpowin115': (6.605968230747892e-05, 1.0125991461405333, 17.96728350708451),
            'fpowin230': (4.634428233657273e-05, 1.0183515407387007, 16.559644350684962),
        }),
    ]
